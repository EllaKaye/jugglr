...
By default, `animate()` opens the animation in your browser or in the Viewer pane of your IDE, if that's where you're calling it from, or in a browser otherwise. 
Setting the `path` argument allows you to save the GIF to disk at the specified location.
